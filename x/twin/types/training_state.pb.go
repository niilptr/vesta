...
func (m *TrainingState) GetName() string {
	if m != nil {
		return m.Name
	}
	return ""
...
var fileDescriptor_672fc39fef593be7 = []byte{
	...
	0x03, 0x29, 0x50, 0xb2, 0xe4, 0xe2, 0x0d, 0x81, 0xaa, 0x09, 0x06, 0x29, 0x11, 0x12, 0xe1, 0x62,
	0x2d, 0x4b, 0xcc, 0x29, 0x4d, 0x95, 0x60, 0x54, 0x60, 0xd4, 0xe0, 0x08, 0x82, 0x70, 0x84, 0x84,
	0xb8, 0x58, 0xf2, 0x12, 0x73, 0x53, 0x25, 0x98, 0x14, 0x18, 0x35, 0x38, 0x83, 0xc0, 0x6c, 0x27,
	0x9d, 0x13, 0x8f, 0xe4, 0x18, 0x2f, 0x3c, 0x92, 0x63, 0x7c, 0xf0, 0x48, 0x8e, 0x71, 0xc2, 0x63,
	0x39, 0x86, 0x0b, 0x8f, 0xe5, 0x18, 0x6e, 0x3c, 0x96, 0x63, 0x88, 0x12, 0x82, 0xb8, 0xa0, 0x02,
	0xea, 0x86, 0xca, 0x82, 0xd4, 0xe2, 0x24, 0x36, 0xb0, 0xdd, 0xc6, 0x80, 0x00, 0x00, 0x00, 0xff,
	0xff, 0x7f, 0xe3, 0xd0, 0x08, 0x9e, 0x00, 0x00, 0x00,
}
...
func (m *TrainingState) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if len(m.Name) > 0 {
		i -= len(m.Name)
		copy(dAtA[i:], m.Name)
		i = encodeVarintTrainingState(dAtA, i, uint64(len(m.Name)))
		i--
		dAtA[i] = 0x12
	}
	if m.Value {
